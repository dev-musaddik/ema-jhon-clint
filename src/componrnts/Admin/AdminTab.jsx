...
function AdminTab({userdata,user}) {
  ...
  const {dataFromSarver}=useContext(myContext)
  if (Array.isArray(dataFromSarver)) {
    // Your map code here
  } else {
    console.error('serverData is not an array');
  }
  let totalPrice=0
  return (
    <>
      <div className="container mx-auto">
        <div className="tab container mx-auto ">
          <Tabs defaultIndex={0} className=" ">
            ...
            {/* product  */}
            <TabPanel>
              <div className="  px-0 md:px-0 mb-16">
                <h1
                ...
                <div className=" flex justify-end">
                  ...
                  >
                    {" "}
                    <div className="flex gap-2 items-center">
                      <Link to='addproduct'>Add Product</Link> <FaCartPlus size={20} />
                    </div>
                  </button>
                </div>
                    ...
                    <tbody className="">
                     {
                      ...
                      >
                        ...
                        >
                          <img
                            className="w-16"
                            src={data.img ? data.img :`https://dummyimage.com/720x400`}
                            alt="img"
                          />
                        </th>
                        <td
